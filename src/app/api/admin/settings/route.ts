...
const DEFAULT_SETTINGS = [
  ...
  },
  {
    ...
    description: "แสดงต่อท้ายชื่อเว็บบนแท็บเบราว์เซอร์ เช่น \"BUYAPP - กล่องสุ่มสินค้าพรีเมียม\" — เว้นว่าง = แสดงเฉพาะชื่อเว็บ",
    type: "text",
    group: "ทั่วไป",
  },
  {
  ...
  },
  {
    ...
    value: "",
    label: "TrueMoney Link Token",
    description: "Bearer Token สำหรับสร้างลิงก์ขอรับเงิน (TRUEMONEY_LINK_TOKEN)",
    type: "text",
    group: "กระเป๋าเงิน",
  },
  {
    ...
    value: "",
    label: "TrueMoney Receive Token",
    description: "Bearer Token สำหรับตรวจสอบรายการรับเงิน (TRUEMONEY_RECEIVE_TOKEN)",
    type: "text",
    group: "กระเป๋าเงิน",
  },
  {
  ...
  },
  {
    ...
    value: "",
    label: "Discord Webhook URL (แจ้งเตือนแชท)",
    description: "Webhook สำหรับแจ้งเตือนทีมงานเมื่อลูกค้าส่งข้อความแชท",
    type: "text",
    group: "Discord",
  },
  {
    ...
    description: "Token ของ Discord Bot สำหรับระบบ Ticket",
    type: "text",
    group: "Discord",
  },
  {
    ...
    value: "",
    label: "Discord Guild ID (Server ID)",
    description: "ID ของ Discord Server ที่ Bot อยู่",
    type: "text",
    group: "Discord",
  },
  {
    ...
    value: "",
    label: "Discord Ticket Channel ID",
    description: "ID ของ Channel สำหรับเปิด Ticket/Thread",
    type: "text",
    group: "Discord",
  },
  {
    key: "slip2go_api_key",
    value: "",
    label: "Slip2Go API Key",
    description: "API Key สำหรับยืนยันสลิปโอนเงิน PromptPay",
    type: "text",
    group: "Integrations",
  },
  {
    key: "byshop_api_key",
    value: "",
    label: "Byshop API Key",
    description: "API Key สำหรับซื้อแอพพรีเมี่ยมอัตโนมัติจาก gafiwshop.xyz",
    type: "text",
    group: "Integrations",
  },
  {
    key: "byshop_base_url",
    value: "https://gafiwshop.xyz/api",
    label: "Byshop Base URL",
    description: "Base URL ของ Byshop API",
    type: "text",
    group: "Integrations",
  },
  {
    key: "premium_hero_image",
    value: "",
    label: "รูปภาพพื้นหลัง Hero หน้าแอพพรีเมี่ยม",
    description: "รูปภาพแบนเนอร์แสดงบนสุดของหน้า /premium — เว้นว่าง = ไม่แสดง",
    type: "text",
    group: "แอพพรีเมี่ยม",
  },
  {
